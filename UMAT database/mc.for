...
C     ----- Read material parameters from PROPS array -----
        ...
        COHS = PROPS(4)
        TENS = PROPS(6)
C     ----- calculate elastic stress increment (DSig = elastic stiffness D * strain increment DEps)
...
C     ----- Calculate principle stresses and their direction
...
C     ----- evaluating the yield functions
...
C     ----- Check if the calculated principle stresses are on the yield surface
      SIG1R=SIG1-DSP1
      SIG2R=SIG2-DSP2
      SIG3R=SIG3-DSP3
...
C     ----- Check again if the calculated stresses are on the yield surface
      SIG1R=SIG1-DSP1
      SIG2R=SIG2-DSP2
      SIG3R=SIG3-DSP3
